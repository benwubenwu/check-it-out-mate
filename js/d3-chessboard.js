// Source: https://github.com/jbkunst/d3-chessboard/blob/master/d3-chessboard.js
function d3chessboard() {
    ...
    // var pieces = {
    //   p : { w : pieceSources['White-Pawn'], b: "\u265F"},
    //   k : { w : pieceSources['White-King'], b: "\u265A"},
    //   q : { w : pieceSources['White-Queen'], b: "\u265B"},
    //   r : { w : pieceSources['White-Rook'], b: "\u265C"},
    //   b : { w : pieceSources['White-Bishop'], b: "\u265D"},
    //   n : { w : pieceSources['White-Knight'], b: "\u265E"}
    // }
